...
% CIRCUIT DISCOVERY
% =============================================
\begin{frame}{Three-stage analysis pipeline}
...
SVA & Top heads span L0, L6, L9--11 & \href{https://arxiv.org/abs/2506.22105}{Lazo et al.\ 2025} \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tikzpicture}[
  ...
  \node[result, phoneme] at (5, -0.2) {\large ``Dictator'' $\times$\\[2pt] Richard $\nrightarrow$ Dick};
  \node[result, phoneme] at (10, -0.2) {\large ``Dictator'' $\times$\\[2pt] Dick Tater $\nrightarrow$ fuse};
...
\begin{center}
\includegraphics[width=0.95\textwidth]{../results/plots/summary_bars.png}
\end{center}
...
\begin{tabular}{l|ccccc}
 & \rotatebox{60}{\textbf{Hypo}} & \rotatebox{60}{\textbf{Clip}} & \rotatebox{60}{\textbf{Init}} & \rotatebox{60}{\textbf{Orny}} & \rotatebox{60}{\textbf{Homo}} \\
\hline
\textbf{Clip} & \cellcolor{circuit!25}high & & & & \\
\textbf{Init} & ? & ? & & & \\
\textbf{Orny} & \cellcolor{phoneme!10}low & ? & ? & & \\
\textbf{Homo} & ? & ? & ? & ? & \\
\textbf{Folk} & ? & ? & ? & ? & ? \\
\end{tabular}
\end{center}
...
\vspace{0.3em}
\scriptsize
Op 1--2 (both shortening) predicted high.\\
Op 4 (fusion) predicted low overlap with others.
\end{column}
...
\begin{tabular}{l|cccccc}
 & \rotatebox{60}{\textbf{Hypo}} & \rotatebox{60}{\textbf{Clip}} & \rotatebox{60}{\textbf{Init}} & \rotatebox{60}{\textbf{Orny}} & \rotatebox{60}{\textbf{Homo}} & \rotatebox{60}{\textbf{Folk}} \\
\hline
\textbf{Hypo} & \cellcolor{accent!25}-- & .43 & \cellcolor{chill!12}.25 & \cellcolor{backbone!22}\textbf{.58} & .46 & .50 \\
\textbf{Clip} & .43 & \cellcolor{accent!25}-- & \cellcolor{chill!12}.22 & .40 & .50 & .40 \\
\textbf{Init} & \cellcolor{chill!12}.25 & \cellcolor{chill!12}.22 & \cellcolor{accent!25}-- & \cellcolor{chill!12}.22 & \cellcolor{chill!12}.20 & \cellcolor{chill!12}.25 \\
\textbf{Orny} & \cellcolor{backbone!22}\textbf{.58} & .40 & \cellcolor{chill!12}.22 & \cellcolor{accent!25}-- & .43 & .50 \\
\textbf{Homo} & .46 & .50 & \cellcolor{chill!12}.20 & .43 & \cellcolor{accent!25}-- & .46 \\
\textbf{Folk} & .50 & .40 & \cellcolor{chill!12}.25 & .50 & .46 & \cellcolor{accent!25}-- \\
\end{tabular}
\end{center}
\end{column}
\end{columns}
...
\vspace{0.5em}
\small
\textbf{H1} \checkmark{} 6 heads appear in all 6 circuits --- all in L8--11.\\
\textbf{H2} \checkmark{} Initialism is the most distinct (Jaccard $\leq$ 0.25 with every other task).\\
\textbf{H3} \checkmark{} Oronym--Hypocorism highest overlap (0.58) --- compositional reuse.
\end{frame}

% =============================================
% CIRCUIT OVERLAP — PLOTS
% =============================================
...
\includegraphics[width=\textwidth]{../results/plots/overlap_heatmap.png}
\end{center}
...
% METHOD AGREEMENT
% =============================================
\begin{frame}{Three methods, same answer (1/2)}

\begin{center}
\includegraphics[width=0.95\textwidth,height=0.78\textheight,keepaspectratio]{figures/jaccard_top.png}
\end{center}

\vspace{-0.3em}
EAP-IG, activation patching, and causal discovery agree on circuit heads. Homophone has the highest method agreement (Jaccard 0.67); initialism is the most distinct circuit across tasks.
\end{frame}

\begin{frame}{Three methods, same answer (2/2)}

\begin{center}
\includegraphics[width=0.95\textwidth,height=0.78\textheight,keepaspectratio]{figures/jaccard_bottom.png}
\end{center}

\vspace{-0.3em}
91\% of heads agreed on by all three methods are in layers 8--11. Layer 10 alone accounts for 24 triple-agreed head-task pairs.
\end{frame}
